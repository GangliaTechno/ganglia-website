...
const ProductDetail = () => {
  ...
  return (
    <div className="pt-7 bg-gray-100 min-h-screen pb-12">
      ...
      <div className='w-[90%] mx-auto'>
        {
          product.table && (<Table productName={product.name} />)
        }
      </div>
        {
          product.timelineData && (<Timeline timelineData={product.timelineData}/>)
        }
    </div>
  );
};
  ...
  return (
    <div className="mt-10 bg-white p-6 rounded-lg shadow-lg ">
      ...
      <div className="p-4 lg:ml-36 md:ml-32">
        ...
        {productFeatures.keyFeatures&&(<h2 className="text-2xl font-bold  text-gray-800 mt-4 ">Key Features & Benefits</h2>)}
      </div>
